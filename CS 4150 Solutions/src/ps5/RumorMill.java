...
class Graph {
	...
	public Set<String> getRelation(String name) {
	...
	public Set<String> getFriend(String name) {
		Set<String> set = new HashSet<String>();

		set.addAll(getName(name));
		set.addAll(getRelation(name));
		...
		if (relations.containsKey(name1)) {
			...
			if (!temp.contains(name2)) {
				...
				if (names.containsKey(name2)) {
					...
					// Must re-initialize, otherwise won't pass 7,8 tests
